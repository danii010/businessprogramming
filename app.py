...
# 상단 배너 이미지 (현재 스크립트 실행 위치 기준 절대경로로 안전하게 로드)
import os
...
if os.path.exists(banner_path):
    ...
    # 혹시 모를 파일 유실 상황에 대비해 경고 메시지 표시하고 앱 다운은 방지
    st.warning("⚠️ 배너 이미지(banner.png) 파일을 찾을 수 없습니다. GitHub 저장소 최상위에 banner.png 파일을 업로드해 주세요.")
